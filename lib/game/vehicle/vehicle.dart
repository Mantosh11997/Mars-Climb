...
final Vehicle dustdevil = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.10, -0.58),
  headOffset: Vector2(-0.17, -1.05),
  headRadius: 0.35,
  chassisDensity: 0.5,
  wheelDensity: 0.9,
  headDensity: 0.75,
...
final Vehicle piston = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.61, -0.45),
  headOffset: Vector2(0.34, -0.92),
  headRadius: 0.35,
  chassisDensity: 0.7,
  wheelDensity: 0.9,
  headDensity: 0.8,
...
final Vehicle gecko = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.11, -0.62),
  headOffset: Vector2(-0.16, -1.09),
  headRadius: 0.35,
  chassisDensity: 0.55,
  wheelDensity: 0.9,
  headDensity: 0.7,
...
final Vehicle ionwing = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.26, -0.56),
  headOffset: Vector2(-0.01, -1.03),
  headRadius: 0.35,
  chassisDensity: 0.42,
  wheelDensity: 0.9,
  headDensity: 0.65,
...
final Vehicle needle = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.77, -0.43),
...
final Vehicle ratchet = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.05,
  driverOffset: Vector2(0.26, -0.58),
  headOffset: Vector2(-0.01, -1.05),
  headRadius: 0.35,
  chassisDensity: 0.58,
  wheelDensity: 0.9,
  headDensity: 0.8,
...
final Vehicle trilobite = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.19, -0.60),
  headOffset: Vector2(-0.47, -1.10),
  headRadius: 0.36,
  chassisDensity: 1.1,
  wheelDensity: 0.9,
  headDensity: 0.4,
...
final Vehicle wasp = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.28, -0.54),
  headOffset: Vector2(-0.56, -1.04),
  headRadius: 0.36,
  chassisDensity: 0.8,
  wheelDensity: 0.9,
  headDensity: 0.6,
...
final Vehicle kite = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.24, -0.46),
  headOffset: Vector2(-0.52, -0.95),
  headRadius: 0.36,
  chassisDensity: 0.9,
  wheelDensity: 0.9,
  headDensity: 0.5,
...
final Vehicle haulertrike = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.10, -0.54),
  headOffset: Vector2(-0.39, -1.04),
  headRadius: 0.36,
  chassisDensity: 1.7,
  wheelDensity: 0.9,
  headDensity: 0.35,
...
final Vehicle compass = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.15, -0.49),
  headOffset: Vector2(-0.43, -0.98),
  headRadius: 0.36,
  chassisDensity: 1.0,
  wheelDensity: 0.9,
  headDensity: 0.45,
...
final Vehicle cinder = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.28, -0.49),
  headOffset: Vector2(-0.56, -0.98),
  headRadius: 0.36,
  chassisDensity: 0.95,
  wheelDensity: 0.9,
  headDensity: 0.6,
...
final Vehicle stilt = Vehicle(
  ...
  driverBehind: true,
  driverScale: 1.1,
  driverOffset: Vector2(-0.28, -0.52),
  headOffset: Vector2(-0.56, -1.01),
  headRadius: 0.36,
  chassisDensity: 0.85,
  wheelDensity: 0.9,
  headDensity: 0.9,
